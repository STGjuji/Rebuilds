    ...
    >
      ...
      <div class="flex space-x-2 mt-4 lg:mt-0">
        ...
        <div class="flex text-xs">
          ...
          <a
            href="#"
            class="border border-gray-400 border-l-0 rounded rounded-l-none font-semibold px-3 py-1 hover:text-blue-600"
            >25.3k</a
          >
        </div>
        <div class="flex text-xs">
      ...
      <div class="file-explorer-container w-full lg:w-3/4 lg:mr-8">
        <div class="branch-navigation flex items-center justify-between">
          <div class="flex items-center space-x-3">
            ...
            <a
              href="#"
              class="hidden py-1 lg:flex items-center space-x-2 group"
            >
              <svg
                class="fill-current text-gray-600 group-hover:text-blue-600 w-4"
                text="gray"
        ...
        >
          ...
          <div class="flex items-end">
            ...
            <a
              href="#"
              class="font-mono text-xs text-gray-600 hover:underline hover:text-blue-500 ml-2 hidden lg:block"
              >da070bd</a
            >
            <a
              href="#"
        ...
        <div
          class="readme-container rounded-md border border-gray-400 px-4 py-4 mt-4"
        >
        ...
        <div class="used-by border-t border-gray-400 mt-6 pt-6">
          ...
          <div class="mt-4">
            <a href="#" class="flex items-center -space-x-2">
              ...
              />
              <img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/gusoto/128.jpg"
                class="w-8 rounded-full border-2 border-white"
                alt="avatar"
              />
              <img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/rodnylobos/128.jpg"
                class="w-8 rounded-full border-2 border-white"
                alt="avatar"
              />
              <span
